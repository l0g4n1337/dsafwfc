...
class BasePlayer:
    ...
    async def idling_mode(self):
        ...
        if (played := len(self.played)) or self.last_track:
            buttons.append(["<:bckwrd:958995440504832050>", "back", "Riproduci il brano precedente"])
        ...
        buttons.extend(
            [
                ["<:oktagon:959013046460764170>", "stop", "Interrompila riproduzione"],
                ["<:addsong:958997764694474772>", "add_song", "Richiedi una canzone"],
                ["<:stardt:959012001244405840>", "enqueue_fav", "Aggiungi preferiti in coda"]
            ]
        )
